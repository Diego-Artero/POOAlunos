...
namespace Api_Hexagonal.Services
{
    public class AlunoService : IAlunoService
    {
        ...
        private readonly ICursoRepository _curso_repository;
        public AlunoService(IAlunoRepository repository, ICursoRepository curso_repository )
        {
            _repository = repository;
            _curso_repository = curso_repository;
        }
        ...
        public void Matricular(Guid alunoId, Guid cursoId)
        {
            ...
            Curso curso = _curso_repository.GetById(cursoId);
            if (curso == null)
